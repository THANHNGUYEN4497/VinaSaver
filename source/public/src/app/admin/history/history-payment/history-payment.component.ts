...
export class HistoryPaymentComponent implements OnInit {
    ...
    number_per_page = 10;
    pager = 1;
    model = { company_name: '', start_date_tst: 0, end_date_tst: 0, start_date_fmt: "", end_date_fmt: "" };
    ...
    private handleResponse(commonResponse: any) {
        ...
        if (commonResponse.success) {
            this.payments = commonResponse.data.data;
    ...
    //----------delete--------------//
    onDelete(id: number) {
        this.modalComponent.setBody("決済を削除します。");
